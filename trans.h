...
extern void pvStore(const uint64 hash, const basic_move_t move, const uint8 depth, const int16 value, const int thread);
extern void pvHashTableClear(pvhashtable_t* pvt);
